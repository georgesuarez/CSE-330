...
{
	if (ptr == root && ptr->data == x && ptr->lptr == nullptr && ptr->rptr == nullptr)
	{
		// Delete Root
		delete ptr;
		tsize--;
	...
	else if (ptr->lptr->data == x && ptr->lptr->lptr == nullptr && ptr->lptr->rptr == nullptr)
	{
		delete ptr->lptr;
		ptr->lptr = nullptr;
		tsize--;
	...
	else if (ptr->rptr->data == x && ptr->rptr->lptr == nullptr && ptr->rptr->rptr == nullptr)
	{
		delete ptr->rptr;
		ptr->rptr = nullptr;
		tsize--;
